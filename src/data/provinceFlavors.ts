...
export const PROVINCE_FLAVORS: ProvinceFlavor[] = [
  ...
  { province: "江西", flavor: "鲜辣", taste: "鲜辣", color: FLAVOR_COLORS["香辣"], description: "赣菜鲜辣咸香兼备，辣度不亚于川湘甚至更胜一筹，是名副其实的吃辣大省" },
  ...
  { province: "湖南", flavor: "香辣", taste: "香辣", color: FLAVOR_COLORS["香辣"], description: "湘菜以鲜辣椒、剁椒为灵魂，香辣为主（非麻辣），味重色浓，煨、炒见长" },
...
export const CUISINE_FLAVORS: CuisineFlavor[] = [
  // 八大菜系
  { cuisine: "鲁菜", flavor: "咸鲜", taste: "咸鲜", color: FLAVOR_COLORS["咸鲜"], description: "鲁菜是八大菜系中唯一的北方菜系，源于春秋战国，被誉为「北方菜系之冠」。咸鲜为主，注重火候，擅长爆、烧、炒、扒，「清汤、奶汤」双绝。分济南菜、胶东菜、孔府菜三大流派，影响整个北方饮食文化，北京烤鸭的烤制技艺受鲁菜影响深远。", originProvinces: ["山东"] },
  ...
  { cuisine: "粤菜", flavor: "清淡", taste: "清淡", color: FLAVOR_COLORS["清淡"], description: "粤菜是中国最早走向世界的菜系，源于先秦，清代「食在广州」名扬天下。清淡鲜美，注重原味，讲究「镬气」，追求「清中求鲜，淡中求美」。分广府菜、潮州菜、东江菜（客家菜）三大流派，早茶点心文化兴盛，烧腊技艺精湛，煲汤养生文化深厚。2021年潮州菜烹饪技艺入选国家级非遗。", originProvinces: ["广东", "香港", "澳门"] },
  { cuisine: "苏菜", flavor: "清淡", taste: "清淡", color: FLAVOR_COLORS["清淡"], description: "苏菜是「文人菜」代表，源于先秦，唐宋江南繁荣后大发展。清淡鲜美，注重本味，刀工精细冠绝天下。分金陵菜、淮扬菜、苏锡菜、徐海菜四大流派，炖焖技艺精湛，满汉全席中淮扬菜占重要地位，是新中国国宴菜的基础。", originProvinces: ["江苏"] },
  ...
  { cuisine: "湘菜", flavor: "香辣", taste: "香辣", color: FLAVOR_COLORS["香辣"], description: "湘菜源于先秦楚文化，与川菜并称「辣味双雄」，但重在「香辣」而非「麻辣」。味重色浓，煨、炒见长。分湘江流域菜、洞庭湖区菜、湘西山区菜三大流派，腊味文化独特，剁椒、豆豉善用，剁椒鱼头是湘菜名片，是中国最具人气的菜系之一。", originProvinces: ["湖南"] },
  ...
  // 地方菜系
  { cuisine: "京菜", flavor: "咸鲜", taste: "咸鲜", color: FLAVOR_COLORS["咸鲜"], description: "京菜融合宫廷菜、官府菜、民间菜与清真菜，是元明清三代帝都饮食文化的结晶。咸鲜为主，酱香浓郁，烤、涮、爆、炒见长。北京烤鸭源于南京烤鸭，经鲁菜烤技改良发展而来，涮羊肉源于蒙古，分仿膳菜、民间菜、清真菜三大流派。", originProvinces: ["北京"] },
  ...
  { cuisine: "赣菜", flavor: "鲜辣", taste: "鲜辣", color: FLAVOR_COLORS["香辣"], description: "赣菜源于赣鄱大地，咸鲜辣兼备，辣度不亚于川湘甚至更胜一筹，是「名副其实的吃辣大省」。米粉文化发达，南昌拌粉、景德镇冷粉各具特色。瓦罐汤文化独特，是南昌早餐标配。三杯鸡源于江西宁都，后传入台湾成为名菜。", originProvinces: ["江西"] },
  ...
  { cuisine: "琼菜", flavor: "清淡", taste: "清淡", color: FLAVOR_COLORS["清淡"], description: "琼菜源于海南岛，清淡鲜美，椰风海韵。四大名菜（文昌鸡、嘉积鸭、东山羊、和乐蟹）享誉华南。椰子入菜独特，椰子鸡、椰子饭别具风味。海南粉、抱罗粉是海南早餐灵魂，清补凉是消暑佳品。", originProvinces: ["海南"] },
  { cuisine: "滇菜", flavor: "酸辣", taste: "酸辣", color: FLAVOR_COLORS["酸辣"], description: "滇菜源于云南高原，少数民族风味丰富，是中国最具民族特色的菜系之一。酸辣鲜香，辣度不低，菌菇见长。野生菌种类冠绝全国，松茸、牛肝菌、鸡枞是云南山珍。过桥米线源于蒙自，已有三百余年历史，是滇菜名片。", originProvinces: ["云南"] },
  ...
  { cuisine: "客家菜", flavor: "咸鲜", taste: "咸鲜", color: FLAVOR_COLORS["咸鲜"], description: "客家菜源于中原汉人南迁，保留大量唐宋古风。讲究「肥、咸、香」，适应迁徙劳作之需。「无菜不酿」，酿豆腐、酿茄子、酿苦瓜是经典。「盐焗」独特工艺，盐焗鸡是客家名片。客家菜烹饪技艺入选广东省省级非物质文化遗产。", originProvinces: ["广东", "福建", "江西"] },
