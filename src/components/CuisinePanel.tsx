...
const CUISINE_DETAILS: Record<string, {
  ...
  鲁菜: {
    ...
    history: "鲁菜源于春秋战国，齐桓公御厨易牙善调味，南北朝贾思勰《齐民要术》总结黄河中下游烹饪技艺。明清两代鲁菜成为宫廷菜基础，北京烤鸭即源于鲁菜烤技。鲁菜是八大菜系中唯一的北方菜系，影响整个北方饮食文化，被誉为「北方菜系之冠」。",
  ...
  粤菜: {
    ...
    history: "粤菜源于先秦，汉唐已具规模。广州自唐代起为通商口岸，融汇中外饮食。清代「食在广州」名扬天下。粤菜是中国最早走向世界的菜系，海外中餐馆以粤菜为主，2021年粤菜烹饪技艺入选国家级非遗。",
  ...
  苏菜: {
    ...
    history: "苏菜源于先秦，唐宋时期江南经济文化繁荣，苏菜随之发展。明清时期淮扬菜成为宫廷菜基础，满汉全席以淮扬菜为主。苏菜以「文人菜」著称，讲究刀工与火候，是新中国国宴菜的基础。",
    region: "江苏全省，辐射长三角地区",
    schools: [
  ...
  京菜: {
    ...
    history: "京菜融合宫廷菜、官府菜、民间菜与清真菜，是元明清三代帝都饮食文化的结晶。北京烤鸭源于鲁菜烤技，经全聚德、便宜坊发扬光大。涮羊肉源于蒙古，清代宫廷盛行后传入民间。",
    region: "北京，辐射京津冀",
    schools: [
  ...
  冀菜: {
    ...
    signatureDishes: ["驴肉火烧", "石家庄安徽板面", "保定三宝", "唐山棋子烧饼", "承德拨御面"],
